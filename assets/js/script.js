$(document).ready(function(){
    ...
    $('#searchGitHub').on('click', function(){
      let username = $('#searchUser').val();
      $.ajax({
          url:'https://api.github.com/users/'+username,
          data:{
            client_id:'fd4688113ece9cb90c36',
            client_secret:'4fa969d7a96dd7c75c2a7a6b0d27919e66bec87a'
          }
      }).done(function(user){
        $.ajax({
        ...
        $('#profile').html(`
          ...
          <h3 class="page-header">Últimos Repositórios</h3>
